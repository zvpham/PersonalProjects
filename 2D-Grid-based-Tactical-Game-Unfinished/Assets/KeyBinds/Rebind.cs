...
public class Rebind : MonoBehaviour
{
    ...
    public PlayerActionName action;
    ...
    public void KeyChange(PlayerActionName action, List<KeyCode> newKeyBinds)
    {
    ...
    private bool CheckDuplicateBindings(PlayerActionName action)
    {
        foreach (PlayerActionName key in keyBindings.defaultActionKeyBinds.Keys)
        {
    ...
    public bool SwapKeyBinds(PlayerActionName action, List<KeyCode> currentKeyBinds)
    {
