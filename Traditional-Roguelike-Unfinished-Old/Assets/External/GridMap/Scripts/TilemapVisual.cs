...
public class TilemapVisual : MonoBehaviour {
    ...
    public struct TilemapSpriteUV {
        public TilemapSetUp.TilemapObject.TilemapSprite tilemapSprite;
    ...
    private Grid<TilemapSetUp.TilemapObject> grid;
    private Mesh mesh;
    private bool updateMesh;
    private Dictionary<TilemapSetUp.TilemapObject.TilemapSprite, UVCoords> uvCoordsDictionary;
    ...
    private void Awake() {
        ...
        uvCoordsDictionary = new Dictionary<TilemapSetUp.TilemapObject.TilemapSprite, UVCoords>();
    ...
    public void SetGrid(TilemapSetUp tilemap, Grid<TilemapSetUp.TilemapObject> grid) {
        this.grid = grid;
        UpdateHeatMapVisual();
    ...
    private void Grid_OnGridValueChanged(object sender, Grid<TilemapSetUp.TilemapObject>.OnGridObjectChangedEventArgs e) {
        updateMesh = true;
    }
    ...
    private void UpdateHeatMapVisual() {
        ...
        for (int x = 0; x < grid.GetWidth(); x++) {
            for (int y = 0; y < grid.GetHeight(); y++) {
                ...
                TilemapSetUp.TilemapObject gridObject = grid.GetGridObject(x, y);
                TilemapSetUp.TilemapObject.TilemapSprite tilemapSprite = gridObject.GetTilemapSprite();
                Vector2 gridUV00, gridUV11;
                if (tilemapSprite == TilemapSetUp.TilemapObject.TilemapSprite.None) {
