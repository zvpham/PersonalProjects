...
public class AStarPathfindingNoDiagonal 
{
    ...
    public AStarPathfindingNoDiagonal(int width, int height, List<Vector3> walkableSpaces, Vector3 orginPosition) 
    {
    ...
    public AStarPathfindingNoDiagonal(int width, int height, Vector3 orginPosition)
    {
        grid = new Grid<AStarPathNode>(width, height, 1f, orginPosition, (Grid<AStarPathNode> g, int x, int y) => new AStarPathNode(g, x, y, true));
    }
