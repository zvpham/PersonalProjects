...
{
    public override void CreateGridOfObjects(GameManager gameManager, int fieldRadius, Vector3 originPosition)
    {
        ...
        gameManager.StatusObjectDuration.Add(fieldDuration);
