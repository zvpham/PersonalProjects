...
public static class FindNearestOpenSpace
{
    ...
    public static Vector3 FindEmptySpace(Unit targetUnit, bool CareAboutWalls)
    {
        debugWord = "";
        ...
        return FindPath(targetUnit, !CareAboutWalls);
    }
    ...
    private static Vector3 FindPath(Unit targetUnit, bool ignoreWalls)
    {
        ...
        while (openList.Count > 0)
        {
            ...
            foreach (Vector3 neighborNode in GetNeighborList(currentNode))
            {
                ...
                {
                    return new Vector3(neighborNode.x, neighborNode.y, 0);
                }
            }
        }
