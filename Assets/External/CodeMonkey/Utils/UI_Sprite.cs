...
namespace CodeMonkey.Utils {
    ...
    public class UI_Sprite {
        ...
        public static UI_Sprite CreateDebugButton(Vector2 anchoredPosition, Vector2 size, System.Action ClickFunc) {
            return CreateDebugButton(anchoredPosition, size, ClickFunc, Color.green);
        }
        public static UI_Sprite CreateDebugButton(Vector2 anchoredPosition, Vector2 size, System.Action ClickFunc, Color color) {
        ...
        public static UI_Sprite CreateDebugButton(Vector2 anchoredPosition, string text, System.Action ClickFunc) {
            return CreateDebugButton(anchoredPosition, text, ClickFunc, Color.green);
        }
        public static UI_Sprite CreateDebugButton(Vector2 anchoredPosition, string text, System.Action ClickFunc, Color color) {
            return CreateDebugButton(anchoredPosition, text, ClickFunc, color, new Vector2(30, 20));
        }
        public static UI_Sprite CreateDebugButton(Vector2 anchoredPosition, string text, System.Action ClickFunc, Color color, Vector2 padding) {
        ...
        public static UI_Sprite CreateDebugButton(Vector2 anchoredPosition, Vector2 size, System.Action ClickFunc, Color color, string text) {
            UI_TextComplex uiTextComplex;
            return CreateDebugButton(anchoredPosition, size, ClickFunc, color, text, out uiTextComplex);
        }
        public static UI_Sprite CreateDebugButton(Vector2 anchoredPosition, Vector2 size, System.Action ClickFunc, Color color, string text, out UI_TextComplex uiTextComplex) {
        ...
        public Button_UI AddButton(System.Action ClickFunc, System.Action MouseOverOnceFunc, System.Action MouseOutOnceFunc) {
