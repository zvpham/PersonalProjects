...
namespace CodeMonkey.Utils {
    ...
    /*
     * Triggers a System.Action after a certain time 
     * */
    public class FunctionTimer {
        ...
        public static FunctionTimer Create(System.Action action, float timer) {
            return Create(action, timer, "", false, false);
        }
        public static FunctionTimer Create(System.Action action, float timer, string functionName) {
            return Create(action, timer, functionName, false, false);
        }
        public static FunctionTimer Create(System.Action action, float timer, string functionName, bool useUnscaledDeltaTime) {
            return Create(action, timer, functionName, useUnscaledDeltaTime, false);
        }
        public static FunctionTimer Create(System.Action action, float timer, string functionName, bool useUnscaledDeltaTime, bool stopAllWithSameName) {
            InitIfNeeded();
        ...
        public FunctionTimer(GameObject gameObject, System.Action action, float timer, string functionName, bool useUnscaledDeltaTime) {
        ...
        public class FunctionTimerObject {
            ...
            public FunctionTimerObject(System.Action callback, float timer) {
        ...
        public static FunctionTimerObject CreateObject(System.Action callback, float timer) {
