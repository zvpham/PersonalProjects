...
namespace CodeMonkey.Utils {
    ...
    public static class UtilsClass {
        ...
        // Create Text in the World
        public static TextMesh CreateWorldText(Transform parent, string text, Vector3 localPosition, int fontSize, Color color, TextAnchor textAnchor, TextAlignment textAlignment, int sortingOrder, float characterSize = 0.1f) {
        ...
        public static FunctionUpdater CreateMouseClickAction(System.Action<Vector3> onMouseClick) {
            return CreateMouseClickAction(0, onMouseClick);
        }

        public static FunctionUpdater CreateMouseClickAction(int mouseButton, System.Action<Vector3> onMouseClick) {
            return FunctionUpdater.Create(() => {
                if (Input.GetMouseButtonDown(mouseButton)) {
        ...
        public static FunctionUpdater CreateKeyCodeAction(KeyCode keyCode, System.Action onKeyDown) {
            return FunctionUpdater.Create(() => {
