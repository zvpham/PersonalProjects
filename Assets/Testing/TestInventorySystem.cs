...
namespace Inventory.Model
{
    ...
    public class TestInventorySystem : MonoBehaviour
    {
        ...
        public ItemTypes mainItemFilter;
        public List<ItemTypes> subItemFilters;
        ...
        private void PrepareUI()
        {
            ...
            this.inventoryUI.OnMainFilterChanged += HandleMainItemTypePressed;
            this.inventoryUI.OnFiltersChanged += HandleFiltersChanged;
        }
        ...
        public void HandleMainItemTypePressed(int itemTypeIndex)
        {
            switch (itemTypeIndex)
            {
                case 0:
                    mainItemFilter = ItemTypes.Weapon;
                    break;
                case 1:
                    mainItemFilter = ItemTypes.Armor;
                    break;
                case 2:
                    mainItemFilter = ItemTypes.Accessory;
                    break;
                case 3:
                    mainItemFilter = ItemTypes.SkillBook;
                    break;
            }
        }

        public void HandleFiltersChanged(int mainItemTypeIndex, int subItemTypeIndex)
        {
            subItemFilters.Clear();
            switch (mainItemTypeIndex)
            {
                case 0:
                    switch (subItemTypeIndex)
                    {
                        case 0:
                            List<ItemTypes> weaponItemTypes =  new List<ItemTypes>() { ItemTypes.Sword, ItemTypes.Axe, ItemTypes.Spear, ItemTypes.Hammer, ItemTypes.Mace, ItemTypes.Bow, ItemTypes.Crossbow };
                            subItemFilters = weaponItemTypes;
                            break;
                        case 1:
                            subItemFilters.Add(ItemTypes.Sword);
                            break;
                        case 2:
                            subItemFilters.Add(ItemTypes.Axe);
                            break;
                        case 3:
                            subItemFilters.Add(ItemTypes.Spear);
                            break;
                        case 4:
                            subItemFilters.Add(ItemTypes.Hammer);
                            break;
                        case 5:
                            subItemFilters.Add(ItemTypes.Mace);
                            break;
                    }
                    break;
                case 1:
                    ...
                    {
                        case 0:
                            List<ItemTypes> armorItemTypes = new List<ItemTypes>() { ItemTypes.Helmet, ItemTypes.Chest, ItemTypes.Legs };
                            subItemFilters = armorItemTypes;
                            break;
                        case 1:
                            subItemFilters.Add(ItemTypes.Helmet);
                            break;
                        case 2:
                            subItemFilters.Add(ItemTypes.Chest);
                            break;
                        case 3:
                            subItemFilters.Add(ItemTypes.Legs);
                            break;
                    }
                    break;
                case 2:
                    ...
                    {
                        case 0:
                            List<ItemTypes> accessortItemTypes = new List<ItemTypes>() { ItemTypes.Ring, ItemTypes.Ammo};
                            subItemFilters = accessortItemTypes;
                            break;
                        case 1:
                            subItemFilters.Add(ItemTypes.Ring);
                            break;
                        case 2:
                            subItemFilters.Add(ItemTypes.Ammo);
                            break;
                    }
                    break;
                case 3:
            ...
            for(int i = 0; i < inventoryItems.Count; i++)
            {
                ...
                {
                    EquipableItemSO equipData = (EquipableItemSO)inventoryItems[i].item;
                    ...
                    inventoryUI.UpdateData(inventoryIndex, equipData.itemImage, inventoryItems[i].quantity, equipData.name, equipData.attributeOne, equipData.attributeTwo, equipData.mainCategoryOne, StatToString(equipData.mainOneMin, equipData.mainOneMax), equipData.mainCategoryTwo,
                    StatToString((int)equipData.mainTwoMin, equipData.mainTwoMax), equipData.mainCategoryThree, StatToString(equipData.mainThreeMin,
                    equipData.mainThreeMax), ammoExtension);
                    inventoryIndex += 1;
                }
        ...
        private void HandleAddItemToNewSlot(ItemSO item, int quantity)
        {
            InventoryItem newItem = new InventoryItem();
            newItem.item = item;
