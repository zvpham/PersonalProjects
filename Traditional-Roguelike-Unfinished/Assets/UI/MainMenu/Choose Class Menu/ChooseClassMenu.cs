...
{
    public List<UIClass> jobClasses = new List<UIClass>();
    public List<UIClass> racialClasses = new List<UIClass>();
    ...
    public UIClass UIClassPrefab;
    public GameObject confirmButton;
    public GameData gameData;
    public int maxJobClasses = 1;
    public int maxRaceClasses = 1;

    public List<UIClass> chosenClassList = new List<UIClass>();
    ...
    public void SetClassDescription(Class Class)
    {
        classDescription.SetDescription(Class.description);
    }
        ...
        else
        {
            ...
            else
            {
                ...
                if (maxRaceClasses <= 0)
                {
                    for (int i = 0; i < racialClasses.Count; i++)
                    {
                        racialClasses[i].Deactivate();
                    }
                }
            }
            selectedClass.Activate();
            chosenClassList.Add(selectedClass);
                
        }

        if(chosenClassList.Count > 0)
        {
